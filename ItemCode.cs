...
namespace TextRpg_InvenAndShop
{
    public class itemCode
    {
        ...
        public Item.Weapon longSword = new Item.Weapon("롱소드", 1, 0, 350, 0, 0, "효율이 좋아 인기가 많은 검이다.", "전사");

        public Item.Weapon dagger = new Item.Weapon("단검", 1, 0, 300, 0, 1, "회피율을 증가시킨다.", "도적");

        public Item.Weapon bfSword = new Item.Weapon("B.F. 대검", 4, 0, 1300, 0, 1, "고가의 대검이다.", "전사");

        public Item.Weapon needlessRod = new Item.Weapon("쓸데없이 큰 지팡이", 1, 0, 1250, 0, 2, "쓸큰지. 물뎀은 별로다.", "법사");

        public Item.Weapon recurveBow = new Item.Weapon("곡궁", 2, 0, 700, 0, 1, "공격 속도 계열 아이템 이였던것.", "궁수");
